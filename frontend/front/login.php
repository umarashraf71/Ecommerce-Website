                        ...
                        <div class="col-xs-12">
                            <form id="login-form" method="post">
                                ...
                                <div class="contact-btn">
                                    <button type="button" id="submit" class="fv-btn" onclick="user_login()">Login</button>
                                </div>
                    ...
                    <div class="contact-form-wrap mt--60">
                        ...
                        <div class="col-xs-12">
                            <form id="register-form" method="post">
                                ...
                                <div class="contact-btn">
                                    <button type="button" id="submit" onclick="user_register()" class="fv-btn">Register</button>
                                </div>
                            </form>
                            <div class="form-output">
                                <p class="form-messege " id="reg_msg"></p>
                            </div>
                        </div>
                    </div>
